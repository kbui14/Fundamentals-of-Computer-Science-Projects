...
public class P4_Keivn_Bui_Client
{	
	public static void main(String[] args)
	{
		...
		System.out.println("Project 4 - Demonstration");
		System.out.println("");
		...
		// any given time
		//RollBall(new P4_Bui_Basketball());
		//RollBall(new P4_Bui_Beachball());
		ThrowBall(new P4_Bui_Basketball());		
		//ThrowBall(new P4_Bui_Beachball());
	...
	public static void RollBall(P4_Bui_MovingBall b)
	{
		int name = 0;
	...
	public static void ThrowBall(P4_Bui_MovingBall b)
	{
		int name = 0;
		b.ThrowBall(20, 400);
